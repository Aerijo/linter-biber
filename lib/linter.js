...
module.exports = class Linter {
  constructor(editor, styleConfig, linterInterface, ignoredLints=[], maxLines=1e4) {
    this.editor = editor;
    ...
    const activeStyle = atom.config.get("linter-biber.activeStyle");
    this.style = this.styleRegistry.getStyle(activeStyle);
