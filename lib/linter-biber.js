      ...
      if (child.type !== "field" || child.hasError()) {
        if (child.hasError() && child.type !== "key") {
          if (child.nextSibling === null) {
            ...
            this.makeError({ node: child, id: "019", msg: "Unidentified error in entry field", detail: "Maybe you forgot a comma or # ?. I'll be making this error more sophisticated eventually." });
          }
        }
        return;
      }
