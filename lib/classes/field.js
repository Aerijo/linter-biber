  ...
  checkConstraints(value, type=null) {
    ...
    switch (this.type) {
      ...
      switch (this.datatype) {
        ...
        case "range":
        if (!/^[^\-]*\-+[^\-]*$/.test(value)) {
          return { severity: "warn", id: "065", msg: "Invalid range format" };
        }
        break;
        ...
        if (!validDateFormat(value)) {
          return { severity: "warn", id: "067", msg: "Invalid date format" };
        }
        break;
        case "verbatim":
        break;
        ...
        if (!this.pattern.test(value)) {
          return { severity: "warn", id: "068", msg: "Invalid pattern match" };
        }
        break;
        case "key":
        break;
