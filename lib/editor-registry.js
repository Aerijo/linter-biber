...
module.exports = class EditorRegistry {
  constructor(linterInterface, globalStyleConfig) {
    this.linterInterface = linterInterface;
    this.editorDataByID = new Map();
    this.globalStyleConfig = globalStyleConfig;
  ...
  addSubscription(container, editor) {
    ...
    container.linter = new Linter(editor, this.globalStyleConfig, this.linterInterface, this.ignoredLints, this.maxLines);
