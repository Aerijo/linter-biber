const { constructStyleFromJSON, Style, Field, Constraint, Entry } = require("../citation-classes");

const defaultStyle = constructStyleFromJSON("../resources/default.json");
...
module.exports = {
  ...
  */
  ...
  /*
  * Map from entry alias -> biblatex supported
  *
  * There are more, but they also set defaults and the behaviour will take some work to account for.
  */
  ...
  /*
  * Map from field alias -> biblatex supported
  */
  ...
  */
  ...
  /*
  * These fields can appear anywhere
  */
